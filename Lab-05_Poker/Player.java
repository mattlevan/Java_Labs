...
import java.util.*;
 public class Player
 {
	 ...
	 public void displayBestHand(int payoff, int potential_winnings)
	 {
	      String nameOfHand = "None";
		  if (payoff == 250)
		  ...
		  System.out.println("Best hand: " + nameOfHand);
		  System.out.println("Your bet: " + bet.getBet());
		  System.out.println("Payout: " + potential_winnings);
		  System.out.println();
	 }
